...
public class HeroCollisionHandler implements CollisionHandler{
    private final Hero e;
    ...
    public HeroCollisionHandler(Hero e) {
        this.e = e;
    ...
    public void reactToCollision(Entity e2) {
        if (e2 instanceof Enemy) {
            this.e.setToReset(true);
            return;
        }
        // An entity will call this if it the collision needs to impact the hero.
        // Currently, only called by the hero when it collides with something else.
